...
internal class FakeUserPreferences(context: Context) :
    ...
    override suspend fun setScreenshotsEnabled(enabled: Boolean) {
        screenshots.value = enabled
    }

    override suspend fun setEncryptionEnabled(enabled: Boolean) {
        encryption.value = enabled
    }

    override suspend fun setTapToRevealEnabled(enabled: Boolean) {
        tapReveal.value = enabled
    }

    override suspend fun setTapBehavior(behavior: TapBehavior) {
        tapBehaviorState.value = behavior
    }
    ...
    override suspend fun setShowNextCodeEnabled(enabled: Boolean) {
        showNext.value = enabled
    }
...
internal class FakeAppPreferences(context: Context) :
    ...
    override suspend fun setIconFetchEnabled(enabled: Boolean) {
        iconFetch.value = enabled
    }
}
...
internal class FakeVaultManager(context: Context) : VaultManager(
    ...
    override fun removePassword() {
        passwordRemoved.value = true
    }

    override fun disableBiometric() {
        biometricDisabled.value = true
    }
}
