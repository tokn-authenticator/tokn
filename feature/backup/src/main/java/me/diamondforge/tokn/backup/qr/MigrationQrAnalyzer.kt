...
/**
 * QR decoder dedicated to the migration scanner. Logic mirrors the add-flow analyzer but
 * lives here so feature:backup doesn't depend on feature:add internals.
 */
internal class MigrationQrAnalyzer {
    ...
    fun decode(imageProxy: ImageProxy): String? {
        ...
        val source = PlanarYUVLuminanceSource(
            bytes, rowStride, imageProxy.height,
